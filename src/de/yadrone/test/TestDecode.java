...
//    	Encoder e = new Encoder(System.out);
//        
//        u8 v = new u8(5);
//        e.sendCommand(SerialAbstractManager.NC_ADDRESS, 'a', v.getAsInt());
//        
//        String raw = "#ca>M==Di";
//        raw = raw.substring(3);
//        int[] decoded = Encoder.Decode64(raw.getBytes(), 0, raw.getBytes().length);
//        v.loadFromInt(decoded, 0);
